...
import com.cgvsu.math.ObjWriterException;
...
public class ObjWriter {
    ...
    public static String writeVertex(final ArrayList<Vector3f> vertex) {
    ...
    public static String writeTextureVertex(final ArrayList<Vector2f> textureVertex) {
        StringBuilder s = new StringBuilder();
    ...
    public static String writeNormals(final ArrayList<Vector3f> normals) {
        StringBuilder s = new StringBuilder();
    ...
    public static String writePolygons(final ArrayList<Polygon> polygons) {
